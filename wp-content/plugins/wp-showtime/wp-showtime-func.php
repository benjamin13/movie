...
<?php $rasp = $_GET["location"]; ?>
        <?php if(!empty($rasp)) { ?>
<a href="&date=0">Сегодня</a> | <a href="&date=1">Завтра</a> | <a href="&date=2"><?php echo russian_date("l, j F",strtotime($mayday)+60*60*24*2); ?></a> | <a href="&date=3"><?php echo russian_date("l, j F",strtotime($mayday)+60*60*24*3); ?></a>
        <?php }  
else { ?>
<a href="?date=0">Сегодня</a> | <a href="?date=1">Завтра</a> | <a href="?date=2"><?php echo russian_date("l, j F",strtotime($mayday)+60*60*24*2); ?></a> | <a href="?date=3"><?php echo russian_date("l, j F",strtotime($mayday)+60*60*24*3); ?></a>
        <?php } ?>
